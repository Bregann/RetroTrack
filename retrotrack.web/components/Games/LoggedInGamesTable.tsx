...
import { type LoggedInGameTableProps } from '../../types/App/LoggedInGameTable'
            ...
            <MediaQuery query="(min-width: 1661px)" styles={{ display: 'none' }}>
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <DataTable
                        ...
                        onRowClick={async (row) => { await GetGameInfoForModal(row.gameId) }}
                    />
                </div>
            </Paper>
        </MediaQuery>

        {(showGameModal != null) && modalOpened && <LoggedInModal gameInfo={showGameModal} loggedInModal={setModalOpened} setTableDataUpdateNeeded={props.setTableDataUpdateNeeded}/>}
