...
export default async function Page() {
  ...
  if (cookieStore.has('accessToken')) {
    ...
    await queryClient.prefetchQuery({
      ...
      queryFn: async () => await doQueryGet<GetUserProgressForConsoleResponse>('/api/games/GetUserProgressForConsole?ConsoleId=-1&Skip=0&Take=25&SortByName=true&HideUnstartedGames=true&HideCompletedGames=true', { cookieHeader }),
      staleTime: 60000
    })
  }
