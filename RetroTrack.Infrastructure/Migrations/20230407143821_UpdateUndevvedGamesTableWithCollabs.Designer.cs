...
namespace RetroTrack.Infrastructure.Migrations
{
    ...
    [Migration("20230407143821_UpdateUndevvedGamesTableWithCollabs")]
    partial class UpdateUndevvedGamesTableWithCollabs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RetroTrack.Infrastructure.Database.Models.UndevvedGames", b =>
                {
                    ...
                    b.Property<List<string>>("CollabDevelopers")
                        .HasColumnType("text[]");

                    b.Property<int>("GameConsoleConsoleID")
                        .HasColumnType("integer");

                    b.Property<string>("PrimaryDeveloper")
                        .HasColumnType("text");
